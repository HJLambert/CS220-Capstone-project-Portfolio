  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-black border-x border-zinc-100 dark:border-zinc-800 text-gray-900 dark:text-gray-100 flex flex-col justify-between">
        ...
        <main className="max-w-6xl mx-auto px-8 py-20 flex-1">
          <div className="flex flex-col md:flex-row md:space-x-8">
            ...
            <pre className="hidden md:block md:w-1/2 text-xs overflow-x-auto leading-tight font-mono text-gray-500 dark:text-gray-400 whitespace-pre select-none">
{asciiArt}
            </pre>
          </div>
        </main>
